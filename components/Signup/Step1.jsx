  ...
  return (
    <div>
      <div>
        ...
        <p>Welcome to FABRIC! Before you sign up we would like you to familiarize yourself with our facility <Link href="/useful-links/aup">Acceptable Use Policy (AUP)</Link>. </p>
        <p>
      ...
      <AlertTriangle className="me-2" size={16} /> Before choosing ORCID, Google, Microsoft or GitHub from the list in CILogon page, <b>please try to find your home institution first</b>. Selecting one of these four providers requires additional human-in-the-loop assistance and review and will delay your registration.
      <br></br>
