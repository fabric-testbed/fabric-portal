    ...
    <div className={styleProp}>
      ...
      }
      {
        ...
        <div className="d-flex flex-row justify-content-between">
          ...
          <Link href="/experiments/ssh-keys">
            <button
      ...
      <div className="alert alert-primary" role="alert">
        <span className="me-2"><b>Bastion login</b>: {getSessionItem("bastionLogin")}</span>
        <CopyButton
          id={getSessionItem("bastionLogin")}
          text=""
          btnStyle={"btn btn-sm btn-primary"}
          showCopiedValue={true}
        />
      </div>
      <Tabs activeTab={getSessionItem("sshKeyType") === "Bastion" ? "Bastion" : "Sliver"}>
