      ...
      <table className={`table resource-detail-table`}>
          ...
          <tr>
            <th scope="col" colSpan="2" className="text-center">
              ...
              }
              {
                resource &&
                <span
                  className={`badge bg-${statusMapping[resource.status.state].colorName} px-2 ms-2`}
                >
        ...
        <tbody>
        {
            ...
            <td className="align-middle text-center">
              {
                !resource &&
                <span className="badge bg-secondary px-2">
                  Down
                </span>
              }
              {
                resource &&
                <span
                  className={`badge bg-${statusMapping[resource.status.state].colorName} px-2`}
                >
                  { statusMapping[resource.status.state].state }
                </span>
              }
