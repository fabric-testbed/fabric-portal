...
const columns = [
  {
    content: (resource) => (
      <div>
        <Link
          href={`/resources/sites/${resource.name}`}
          state={{ data: resource }}
        >
    ...
    <div>
      ...
      <div className="mx-2 mb-2 p-2 pb-1 d-flex flex-row justify-content-between bg-light rounded font-monospace">
        ...
        <div className="w-75 d-flex flex-row justify-content-between">
          ...
          <div className="form-check form-check-inline">
            <input className="form-check-input" type="checkbox" id="NVMECheckbox" value="NVME" onChange={(e) => onFilter(e)}/>
            <label className="form-check-label" htmlFor="NVMECheckbox">NVME</label>
          </div>
          <div className="form-check form-check-inline">
            <input className="form-check-input" type="checkbox" id="SmartNICCheckbox" value="SmartNIC" onChange={(e) => onFilter(e)}/>
            <label className="form-check-label" htmlFor="SmartNICCheckbox">SmartNIC</label>
          </div>
          <div className="form-check form-check-inline">
            <input className="form-check-input" type="checkbox" id="SharedNICCheckbox" value="SharedNIC" onChange={(e) => onFilter(e)}/>
            <label className="form-check-label" htmlFor="SharedNICCheckbox">SharedNIC</label>
          </div>
          <div className="form-check form-check-inline">
            <input className="form-check-input" type="checkbox" id="FPGACheckbox" value="FPGA" onChange={(e) => onFilter(e)} />
