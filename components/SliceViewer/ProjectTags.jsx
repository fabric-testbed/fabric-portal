...
export default function SliceViewerProjectTags({ project, tags, showSpinner }) {
  ...
  return (
    <div>
      {showSpinner ? (
        <SpinnerWithText text={"Loading project permissions..."} />
      ) : (
            ...
            <tr>
              <td>
                <a
                  ...
                  rel="noreferrer"
                >
                  <b>Permissions</b><HelpCircle className="ms-1" size={16} />
                </a>
              </td>
              <td>
                {tags.length === 0 ? (
