...
export default function NewSliceDetailForm({ data, nodes, links, selectedCPs, onVMUpdate, onNodeDelete, onConnectionPointSelect, onSingleComponentAdd, onJsonUpload }) {
