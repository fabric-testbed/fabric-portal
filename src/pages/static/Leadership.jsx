...
import IlyaBaldin from "../../imgs/leadership/ilya-baldin.jpg";
import AnitaNikolich from "../../imgs/leadership/anita-nikolich.jpg";
import JimGriffioen from "../../imgs/leadership/jim-griffioen.jpg";
import KuangChingWang from "../../imgs/leadership/kuang-ching-wang.jpg";
import InderMonga from "../../imgs/leadership/inder-monga.jpg";
import TomLehman from "../../imgs/leadership/tom-lehman.jpg";
    ...
    <div className="container pb-5 static-page">
      ...
      <h1 className="mb-5">Leadership Team</h1>
      {
        ...
        <div className="row mb-5" key={`fabric-Leadership-member-${index}`}>
          <div className="col-3">
            <img src={member.photo} alt={`FABRIC Leadership ${member.name}`} className="member-photo-round"/>
          </div>
          <div className="col-9">
