  ...
  return (
    <div>
      <div>
        ...
        <ul>
          <li>Click ‘Proceed’ and you will be redirected to a <a href="https://www.cilogon.org/" target="_blank" rel="noreferrer">CI Logon</a> page, where you can select your institution and login using your <i>institutional username and password</i>. </li>
          <li>After logging in you will be redirected to an enrollment page in FABRIC’s <a href="https://www.incommon.org/software/comanage/" target="_blank" rel="noreferrer">COmanage</a> which will display your name, email and institution. Please verify those and <b>you will be redirected back to this site for more instructions.</b></li>
        </ul>
        <p>
