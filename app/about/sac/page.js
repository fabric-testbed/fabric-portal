    ...
    <div className="container pb-5 static-page">
      ...
      </h2>
      {
        ...
        <div className="row mb-3" key={`fabric-sac-member-${index}`}>
          <div className="col-3">
            <img src={`/imgs/sac/${member.photo}.jpg`} alt={`FABRIC SAC ${member.name}`} className="member-photo-round"/>
          </div>
          <div className="col-9">
