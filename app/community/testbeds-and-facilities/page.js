        ...
        <div className="row mt-5">
          {
            ...
            <div className="testbed-wrapper col-xs-12 col-sm-12 col-md-6 col-lg-4" key={`testbed-${index}`}>
              <div className="testbed-header">
                {testbed.image
                  ? <img src={`/imgs/testbeds/${testbed.image}.png`} alt={testbed.name} className="testbed-logo"/>
                  : <span className="testbed-name-text">{testbed.name}</span>
                }
              </div>
